...
type CommentSore struct {
	db *sql.DB
}

func (s *CommentSore) GetByPostID(ctx context.Context, postID int64) ([]Comment, error) {
...
func (s *CommentSore) Create(ctx context.Context, comment *Comment) error {
	query := `
